  ...
  opts = {
    ...
    keywords = {
      FIX = {
        ...
        alt = { "FIXME", "BUG", "FIXIT", "ISSUE", "ROOTCAUSE" }, -- a set of other keywords that all map to this FIX keywords
        -- signs = false, -- configure signs for some keywords individually
      },
      TODO = { icon = " ", color = "info" },
      HACK = { icon = " ", color = "warning", alt = { "PoC" } },
      WARN = { icon = " ", color = "warning", alt = { "WARNING", "XXX" } },
      PERF = { icon = " ", alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE" } },
      NOTE = { icon = " ", color = "hint", alt = { "INFO", "VIEW", "DATA" } },
      TEST = { icon = "⏲ ", color = "test", alt = { "TESTING", "PASSED", "FAILED" } },
      HIGH = { icon = " ", color = "error", alt = { "issue" } },
      MEDI = { icon = " ", color = "warning", alt = { "ME", "reco" } },
      LOW = { icon = " ", color = "info", alt = { "LO", "note" } },
